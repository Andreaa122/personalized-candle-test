document.addEventListener('DOMContentLoaded', () => {
  ...
  quizForm.addEventListener('submit', (e) => {
    ...
    if ((q3 >= 1 || q13 >= 1) && totalScore <= 20) {
      ...
      if (totalScore <= 10)candleName = 'No candle — you are okay 💛';
     else if (totalScore <= 20){ candleName = 'Calm Moment Candle 🕯️'
      emotion = ' Stress & anxiety & overthinking';
    }else if (totalScore <= 30){ candleName = 'Recharge Candle 🕯️';
      emotion = ' Exhausted';
    }else candleName = 'Joy Candle 🕯️';
    emotion = ' Depression';
    }
...
resultDiv.innerHTML = `
  <div class="result">
    ...
    <p>
      <a href="http://sites.google.com/view/meraki-candles" target="_blank" style="color: #8b5cf6; text-decoration: none; font-weight: bold;">
